...
function FichaCadastro({cadastrar, btnCadastrar, editar, excluir, cancelar,
        ...
        <form>
            ...
            {btnCadastrar ?
                ...
                <div className='d-flex'>
                    ...
                    <input type='button' value='Excluir' className='btn btn-danger form-control' onClick={excluir}/>
